...
def main(page: ft.Page):
    ...
    layout = ft.Column(
        expand = True,
        controls=[
        ft.Text(value="Que bom ter você aqui", size=40, color=ft.colors.WHITE),
        ft.Text(value="Como estão os seus hábitos hoje?", size=20, color=ft.colors.WHITE),
    ...
    ft.Text(value="Marcar suas tarfas como concluído te motiva a continuar focado", size=16, color=ft.colors.WHITE),
